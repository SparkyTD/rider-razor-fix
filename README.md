# IMPORTANT: This tool is highly experimental, and it might break your Rider installation if you don't follow the installation instructions. Only works with EAP version 2022.2 EAP 11. 
___
# RiderRazorFix
...
## Installation
1.a. Download a prebuilt binary (e.g. `%localappdata%\JetBrains\rider-razor-fix.jar`)
1.b. Optionally clone this repo and build it yourself. Make sure to use the `shadowJar` gradle task to generate the .jar file
